      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start mb-16">
          <div className="lg:col-span-7 space-y-6">
            <h2 className="text-2xl font-extrabold font-heading text-brm-navy">
              Sobre a {company.name}
            </h2>
            <p className="text-sm text-gray-700 leading-relaxed">{company.fullDescription}</p>

            <h3 className="text-lg font-bold font-heading text-brm-navy pt-2">
          ...
          {/* Benefits Box */}
          <div className="lg:col-span-5 bg-[#F5F7FA] p-6 sm:p-8 rounded-3xl border border-brm-border space-y-5">
            <div className="flex items-center space-x-2 text-brm-navy">
            ...
            <div className="space-y-4">
              {company.benefits.map((b, idx) => (
                <div key={idx} className="bg-white p-4 rounded-2xl border border-brm-border space-y-1">
                  <h4 className="text-xs font-bold font-heading text-brm-navy">{b.title}</h4>
        ...
        {/* Process Steps */}
        <div className="bg-[#F5F7FA] rounded-3xl p-8 sm:p-10 mb-16 border border-brm-border">
          <h2 className="text-xl sm:text-2xl font-extrabold font-heading text-brm-navy mb-8 text-center">
            Como é feito nosso atendimento
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {company.process.map((step) => (
              <div key={step.step} className="bg-white p-6 rounded-2xl border border-brm-border space-y-3 relative">
                <span
                ...
                <h3 className="text-sm font-bold font-heading text-brm-navy">{step.title}</h3>
