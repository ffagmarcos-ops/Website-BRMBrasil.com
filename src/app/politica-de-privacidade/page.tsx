...
export const metadata: Metadata = {
  title: "Política de Privacidade | Grupo RBM",
  description: "Política de Privacidade e Proteção de Dados Pessoais (LGPD) do Grupo RBM.",
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="prose prose-sm text-gray-700 space-y-6 text-xs sm:text-sm leading-relaxed">
          <section className="space-y-2">
            <h2 className="text-lg font-bold font-heading text-rbm-navy">1. Introdução</h2>
            <p>
              O <strong>Grupo RBM</strong> tem o compromisso de proteger a privacidade e a segurança dos dados pessoais de seus clientes, parceiros, colaboradores e visitantes do nosso site. Esta Política de Privacidade descreve como coletamos, usamos, armazenamos e protegemos suas informações de acordo com a Lei Geral de Proteção de Dados Pessoais (Lei nº 13.709/2018 - LGPD).
            </p>
          </section>

          <section className="space-y-2">
            <h2 className="text-lg font-bold font-heading text-rbm-navy">2. Coleta de Dados Pessoais</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold font-heading text-rbm-navy">3. Finalidade do Tratamento</h2>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold font-heading text-rbm-navy">4. Compartilhamento de Dados</h2>
            <p>
              O Grupo RBM não vende nem aluga dados pessoais a terceiros. O compartilhamento ocorre apenas entre as empresas do Grupo RBM para a prestação integrada de serviços ou quando exigido por obrigação legal.
            </p>
          </section>

          <section className="space-y-2">
            <h2 className="text-lg font-bold font-heading text-rbm-navy">5. Direitos do Titular</h2>
            <p>
          ...
          <section className="space-y-2">
            <h2 className="text-lg font-bold font-heading text-rbm-navy">6. Contato do Encarregado (DPO)</h2>
            <p>
              Para dúvidas sobre esta política ou requisições relacionadas aos seus dados pessoais, entre em contato pelo e-mail: <strong>privacidade@gruporbm.com.br</strong>.
            </p>
          </section>
        </div>
      </div>
