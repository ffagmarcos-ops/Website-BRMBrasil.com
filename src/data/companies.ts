...
export const companies: Company[] = [
  {
    ...
    fullDescription: "A RBM Contabilidade oferece soluções estratégicas em planejamento tributário, gestão financeira, compliance fiscal e departamento pessoal, garantindo total conformidade legal e saúde financeira para o seu negócio crescer de forma sustentável.",
    color: "#39A844",
    ...
    faq: [
      ...
      { question: "A RBM Contabilidade atende empresas de qual porte?", answer: "Atendemos desde microempresas e PMEs até médias e grandes corporações de diferentes segmentos." },
    ],
  },
  {
    id: "mo-publicidade",
  ...
  },
  {
    ...
    fullDescription: "A RBM Desenvolvimento projeta e constrói softwares sob medida, plataformas web, aplicativos móveis, sistemas de gestão personalizados e soluções de Inteligência Artificial para automatizar rotinas e maximizar a eficiência das empresas.",
    color: "#50319A",
  ...
  },
  {
    ...
    fullDescription: "A RBM Sistemas entrega softwares de alta disponibilidade para o mercado. Garantimos agilidade na frente de caixa (PDV), controle rigoroso de estoque, precificação dinâmica, emissão fiscal sem travamentos e integração completa com balanças e leitores.",
    color: "#08AFC4",
