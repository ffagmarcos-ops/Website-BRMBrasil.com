...
export const casesData: CaseItem[] = [
  ...
  },
  {
    ...
    fullStory: "Com o crescimento rápido de suas operações, a EcoVarejo precisava alinhar seus relatórios financeiros e reorganizar o departamento fiscal. A BRM Contabilidade conduziu um planejamento tributário preventivo que reduziu gargalos operacionais.",
    solutionsUsed: ["BRM Contabilidade", "Planejamento Tributário", "Gestão Financeira"],
  ...
  },
  {
    ...
    fullStory: "Para escalar seu atendimento sem elevar custos fixos, a empresa adotou um sistema web personalizado desenvolvido pela BRM Desenvolvimento, integrando fluxos de pedidos e painéis administrativos em tempo real.",
    solutionsUsed: ["BRM Desenvolvimento", "Sistemas Web", "Painel Administrativo"],
